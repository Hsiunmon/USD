...
export class LayoutComponent implements OnInit {
    ...
    public pics = []
    public frompics = [
        { name: 'EWS20180910', path: 'assets/img/ews/usd-lm-pic-1.png' },
        { name: 'EWS20180911', path: 'assets/img/ews/usd-lm-pic-2.png' },
        { name: 'EWS20180912', path: 'assets/img/ews/usd-lm-pic-3.png' },
        { name: 'EWS20180913', path: 'assets/img/ews/usd-lm-pic-4.png' },
        { name: 'EWS20180914', path: 'assets/img/ews/usd-lm-pic-5.png' },
        { name: 'EWS20180915', path: 'assets/img/ews/usd-lm-pic-4.png' },
        { name: 'EWS20180916', path: 'assets/img/ews/usd-lm-pic-1.png' },
    ]

    toggleSidebarListener(state): void {
        console.log('toggleSidebarListener')
    ...
    toggleChatListener(): void {
        console.log('toggleChatListener')
